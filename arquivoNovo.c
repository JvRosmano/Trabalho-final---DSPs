...
void ConfigureADC(void)
{
    ...
    DELAY_US(1000);
    AdcbRegs.ADCSOC0CTL.bit.CHSEL = 2;   // ADCINA2
    AdcbRegs.ADCSOC0CTL.bit.ACQPS = 14;  // sample duration of 20 SYSCLK cycles
    ...
    DELAY_US(1000);
    AdccRegs.ADCSOC0CTL.bit.CHSEL = 2;   // ADCINA2
    AdccRegs.ADCSOC0CTL.bit.ACQPS = 14;  // sample duration of 20 SYSCLK cycles
    ...
    DELAY_US(1000);
    AdcdRegs.ADCSOC0CTL.bit.CHSEL = 14;  // ADCINA2
    AdccRegs.ADCSOC0CTL.bit.ACQPS = 14;  // sample duration of 20 SYSCLK cycles
    AdccRegs.ADCSOC0CTL.bit.TRIGSEL = 5; // ePWM1 SOCA
